...
<body bgcolor="#A0A0A0" vlink="blue" link="blue">
    <div id="page2-div" style="position:relative;width:918px;height:1188px;margin-left: 450px;border: 1px solid black;">
        ...
        <?php $employee_count = isset($get_total_customersData[0]['employee_count']) ? $get_total_customersData[0]['employee_count'] : ''; ?>
        ...
        <?php $Federal_Pin_Number = isset($get_cominfo[0]['Federal_Pin_Number']) ? $get_cominfo[0]['Federal_Pin_Number'] : ''; ?>
        ...
        <?php $company_name = isset($get_cominfo[0]['company_name']) ? $get_cominfo[0]['company_name'] : ''; ?>
        ...
        <?php $address = isset($get_cominfo[0]['address']) ? $get_cominfo[0]['address'] : ''; ?>
        
        <p style="position:absolute;top:361px;left:62px;white-space:nowrap" class="ft216">
            <span> <span style="color: black; font-size: large; position: absolute; bottom: 76px; word-wrap: break-word;">
            <?php
    ...
    <?php $ftotal_amount = isset($get_payslip_info[0]['ftotal_amount']) ? $get_payslip_info[0]['ftotal_amount'] : '0'; ?>
    ...
    <?php $stotal_amount = isset($get_payslip_info[0]['stotal_amount']) ? number_format($get_payslip_info[0]['stotal_amount'], 2) : '0'; ?>
    ...
    <?php $mtotal_amount = isset($get_payslip_info[0]['mtotal_amount']) ? number_format($get_payslip_info[0]['mtotal_amount'], 2) : '0'; ?>
    ...
    <?php $State_Tax_ID_Number = isset($get_cominfo[0]['State_Tax_ID_Number']) ? $get_cominfo[0]['State_Tax_ID_Number'] : ''; ?>
    ...
    <?php $overalltotal_statetax = isset($total_state_tax[0]['overalltotal_statetax']) ? number_format($total_state_tax[0]['overalltotal_statetax'], 2) : '0'; ?>
    ...
    <?php $overalltotal_localtax = isset($total_local_tax[0]['overalltotal_localtax']) ? number_format($total_local_tax[0]['overalltotal_localtax'], 2) : '0'; ?>
    ...
    <?php $email = isset($employeer[0]['email']) ? $employeer[0]['email'] : '';  ?>
