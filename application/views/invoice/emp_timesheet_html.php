        ...
        <tfoot>
            <tr style="color: black;">
                ...
                <td style="text-align: center;">
                    <input type="text" name="total[]" value="<?= $currency . "" .  $total; ?>" style="border: none;" readonly />
                </td>
            </tr>
        </tfoot>
    </table>
    ...
    <table class="mainTable">
        <thead style="background-color: #424f5c;">
            <tr style="color:white;text-align:center;">
                ...
                <th style="text-align:center; color:white;">Cheque Date</th>
            </tr>
        </thead>
        <tbody>
            <tr>
